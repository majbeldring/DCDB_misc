...
# yktr          <- read_csv("M:/data/yktr.csv", col_types = cols(
#   DYR_ID = col_double(),
#   BES_ID = col_double(),
#   KONTROLDATO = col_date(format = ""),
#   EFTERKONTROLFLAG = col_double(),
#   KONTROLNR = col_double(),
#   ANTAL_MALKNINGER = col_double(),
#   KGMAELK = col_double(),
#   FEDTPCT = col_double(),
#   PROTEINPCT = col_double(),
#   CELLETAL = col_double(),
#   UREAMAALING = col_double())
# )
# breed
